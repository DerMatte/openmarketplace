...
const navigation = [
  ...
  { name: "clerk", href: "/clerk", current: false },
];

export default function Navbar() {
  // get current route with app dir beta
  const segments = useSelectedLayoutSegments();
  const currentPath = segments ? "/" : segments[0];
                  ...
                  <button className="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    ...
                    <SignedOut>
                      ...
                      <SignInButton mode="modal">
                        <button
                          className={clsx(
                            "rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-900 hover:text-gray-100 bg-indigo-700 text-gray-50"
                          )}
                        >
                          Sign in
                        </button>
